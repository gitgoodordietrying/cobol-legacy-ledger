...
Dependencies:
    ...
    python.api.routes_health, python.api.routes_chat (optional)
"""
...
def create_app() -> FastAPI:
    ...
    3. Mount banking, codegen, and health routers
    4. Attempt to mount chat router (graceful skip if LLM deps missing)
    5. Register global PermissionError → 403 exception handler
