...
### Python (7 core modules + API + LLM + tests)
...
- `python/tests/` — 280 tests across 15 test files
...
A: The system works without COBOL installed. build.sh skips compilation, seed.sh uses Python file I/O (Mode B). All 280 tests pass in Mode B.
